            ...
            <div className='container container-fluid'>
                <div className='row my-5'>
                    <div className='col-lg-6 col-sm-12'>
                        <img src="https://images.unsplash.com/photo-1501167786227-4cba60f6d58f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className='image image-fluid my-4' alt='dsj' width={'100%'} height={'100%'} ></img>
                    </div>
                    <div className='col-lg-6 col-sm-12 my-5 mx-0 text-center'>
                        <h1>Welcome to the CTC Bank</h1>
                        <ui className='my-3'>
